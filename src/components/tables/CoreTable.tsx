...
export function CoreTable() {
    ...
    const headerElements = (
        <button
            ...
            title="Redefinir todos os Bônus e Penalidades Base para 0"
        >
            🔄 Redefinir Bônus
        </button>
    );
    ...
    return (
        <CollapsingSection title="ATRIBUTOS BASE" headerElements={headerElements}>
            <div className="table-responsive-wrapper">
                <table className="data-table">
                    <thead>
                        <tr className="core-table__header-row">
                            <th className="core-table__header-cell">ATRIB</th>
                            <th>Base</th>
                            <th>Limite</th>
                            <th>Rank</th>
                            <th>Bônus</th>
