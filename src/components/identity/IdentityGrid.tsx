        ...
        <>
            <div className="identity-grid identity-header__grid">
                <div className="identity-grid__row">
                    <span className="identity-grid__label">Apelido</span>
                    <input
                        type="text"
                ...
                <div className="identity-grid__row">
                    <span className="identity-grid__label">
                        Natureza <TooltipIcon onClick={onOpenNature} />
                    </span>
                    <select
                ...
                <div className="identity-grid__row">
                    <span className="identity-grid__label">Tipagem</span>
                ...
                <div className="identity-grid__row">
                    <span className="identity-grid__label">
                        Habilidade <TooltipIcon onClick={onOpenAbility} />
                    </span>
                    <input
                        type="text"
                ...
                <div className="identity-grid__row">
                    <span className="identity-grid__label identity-grid__label--blue">Modo</span>
                    <select
                        className="identity-grid__select"
                ...
                <div className="identity-grid__row identity-header__age-gender-row">
                    <span className="identity-grid__label identity-grid__label--blue">Idade</span>
                    <select
                ...
                <div className="identity-grid__row">
                    <span className="identity-grid__label identity-grid__label--green">Combate</span>
                    <input
                        type="text"
                        className="identity-grid__input"
                ...
                <div className="identity-grid__row">
                    <span className="identity-grid__label identity-grid__label--green">Mão</span>
                    <input
                        type="text"
                        className="identity-grid__input"
                ...
                <div className="identity-grid__row">
                    <span className="identity-grid__label">Rolagens</span>
                    <select
                        className="identity-grid__select"
                        value={identityStore.rolls || 'Public (Everyone)'}
                        onChange={(event) => setIdentity('rolls', event.target.value)}
                    >
                        <option value="Public (Everyone)">Público (Todos)</option>
                        <option value="Private (GM)">Privado (Mestre)</option>
                    </select>
                </div>
            ...
            {deleteCustomInfoId && (
                <div className="identity-header__modal-overlay">
                    <div className="identity-header__modal-content">
                        <h3 className="identity-header__modal-title">⚠️ Confirmar Exclusão</h3>
