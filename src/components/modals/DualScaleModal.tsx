...
export function DualScaleModal() {
    ...
    const formatLabel = (val: string) => {
        if (!val || val === 'none') return 'Nenhuma';
    ...
    return (
        <div className="dual-scale__overlay">
            <div className="dual-scale__content">
                <h3 className="dual-scale__title">⚖️ Opções de Golpe Detectadas</h3>
                <p className="dual-scale__desc">
                    <b>{pendingDualScale.moveName}</b> tem escala variável ou opções ambíguas. Selecione como você
                    quer rolar:
                </p>

                {pendingDualScale.categoryOptions && (
                    <div className="dual-scale__section">
                        <div className="dual-scale__section-title">Categoria do Golpe:</div>
                        <select
                ...
                {pendingDualScale.acc1Options && (
                    <div className="dual-scale__section">
                        <div className="dual-scale__section-title">Atributo de Precisão:</div>
                        <select
                            className="dual-scale__select"
                            value={selectedAcc1}
                ...
                {pendingDualScale.acc2Options && (
                    <div className="dual-scale__section">
                        <div className="dual-scale__section-title">Perícia de Precisão:</div>
                        <select
                            className="dual-scale__select"
                            value={selectedAcc2}
                ...
                {pendingDualScale.dmg1Options && (
                    <div className="dual-scale__section">
                        <div className="dual-scale__section-title">Atributo de Dano:</div>
                        <select
                            className="dual-scale__select"
                            value={selectedDmg1}
