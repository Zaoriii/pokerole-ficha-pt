    ...
    return (
        <div className="tracker-settings__overlay tracker-settings__overlay--high-z">
            <div className="tracker-settings__content tracker-settings__content--placement">
                <h3 className="tracker-settings__title tracker-settings__title--placement">🎯 Ajustar Posicionamento</h3>

                <div className="tracker-settings__placement-grid">
                    <div className="tracker-settings__placement-header">Elemento</div>
                    ...
                    <span className="tracker-settings__placement-label">Barra de HP</span>
                    <NumberSpinner
                    ...
                    <span className="tracker-settings__placement-label">Barra de Will</span>
                    <NumberSpinner
                    ...
                    <span className="tracker-settings__placement-label">Defesas</span>
                    <NumberSpinner
                    ...
                    <span className="tracker-settings__placement-label">Marcador de Ação</span>
                    <NumberSpinner
                    ...
                    <span className="tracker-settings__placement-label">Marcador de Evasão</span>
                    <NumberSpinner
                    ...
                    <span className="tracker-settings__placement-label">Marcador de Confronto</span>
                    <NumberSpinner
