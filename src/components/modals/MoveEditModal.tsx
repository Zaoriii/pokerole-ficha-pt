    ...
    return (
        <div className="move-edit__overlay">
            <div className="move-edit__content">
                <h3 className="move-edit__title">{move.name || 'Nome do Golpe'}</h3>

                <textarea
                    className="move-edit__textarea"
                    placeholder="Descrição e tags do golpe..."
                    value={move.desc || ''}
                ...
                <div className="move-edit__actions">
                    ...
                    <button
                        ...
                        onClick={() => {
                            broadcastInfo(move.name || 'Golpe', move.desc || 'Nenhuma descrição fornecida.');
                            onClose();
                        }}
                    >
                        📢 Transmitir
