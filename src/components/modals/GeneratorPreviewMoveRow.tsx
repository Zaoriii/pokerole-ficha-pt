...
export function GeneratorPreviewMoveRow({
    ...
    const handleTooltipClick = () => {
        ...
        onOpenTooltip({
            title: move.name,
            desc: `Tipo: ${move.type} | Categoria: ${move.cat} | Poder: ${move.power}\nPrecisão: ${move.attr.toUpperCase()} + ${accuracySkillLabel}\nDano: ${damageStatisticLabel}\n\n${move.desc}`
        });
    };
    ...
    return (
        <div className="generator-preview-move">
            ...
            <span className="generator-preview-move__stats">
                [{move.cat.substring(0, 4)}] P:{accuracyPool} | D:{damagePool}
            </span>
