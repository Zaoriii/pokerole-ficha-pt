        ...
        <div className="sheet-panel health-section__box status-box">
            <div className="status-box__header">
                <span className="status-box__header-title">
                    STATUS{' '}
                    <TooltipIcon
                        onClick={() => setTooltipInfo({ title: 'Efeitos de Status', desc: 'Aplica um efeito de status.' })}
                    />
                </span>
            ...
            <div className="status-box__content">
                {statuses.map((status, index) => {
                    ...
                    let statusDesc = STATUS_RULES[status.name] || 'Efeito Personalizado.';
                    if (customStatusData) {
