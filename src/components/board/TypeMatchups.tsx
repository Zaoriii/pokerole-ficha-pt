...
export function TypeMatchups() {
    ...
    if (!type1 && !type2) {
        return (
            <div className="sheet-panel type-matchups__panel">
                <div className="sheet-panel__header type-matchups__header--left">▼ EFETIVIDADES DE TIPO</div>
                <div className="type-matchups__empty">Carregue um Pokémon para ver as efetividades...</div>
            </div>
        );
    }
    ...
    return (
        <CollapsingSection
            title={isTera ? `EFETIVIDADES DE TIPO (TERA: ${teraAffinity.toUpperCase()})` : 'EFETIVIDADES DE TIPO'}
