        ...
        return (
            <div className="init-tracker-wrapper">
                <div className={`init-tracker init-tracker--${layout}`}>
                    <div className="init-tracker__empty">Conectando à Sala...</div>
                </div>
            </div>
        );
    }
        ...
        <>
            <div className={`init-tracker__header init-tracker__header--${layout}`}>
                <div className="init-tracker__turn-controls">
                    <button type="button" className="init-tracker__turn-btn" onClick={prevTurn} title="Turno Anterior">
                        ◀
                    </button>
                    <button type="button" className="init-tracker__turn-btn" onClick={nextTurn} title="Próximo Turno">
                        ▶
                    </button>
                </div>
            </div>
            {combatants.length === 0 ? (
                <div className="init-tracker__empty">Aguardando rolagens...</div>
            ) : (
