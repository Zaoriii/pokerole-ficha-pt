            ...
            <div className="resource-box">
                ...
                <div className="resource-box__main resource-box__content-layer">
                    <div className="resource-box__grid-left">
                        <span className="resource-box__label">Atual:</span>
                    </div>
                    ...
                    >
                        {isEmptyTemp ? (
                            <button
                                ...
                                title={isWill ? 'Adicionar Vontade Temporária' : 'Adicionar Escudo Temporário'}
                            >
                                {isWill ? '🌟 +Temp' : '🛡️ +Temp'}
                            </button>
                        ) : (
                            <>
                                <div className="resource-box__grid-left">
                                    <button
                                        ...
                                        title={isWill ? 'Definir Vontade Temporária' : 'Definir Escudo Temporário'}
                                    >
                                        {isWill ? '🌟' : '🛡️'}
                                    </button>
                                </div>
                                ...
                                <div className="resource-box__grid-right">
                                    {onClearTemp && (
                                        <button
                                            ...
                                            title={isWill ? 'Remover Vontade Temporária' : 'Remover Escudo Temporário'}
                                        >
                                            X
                                        </button>
                                    )}
